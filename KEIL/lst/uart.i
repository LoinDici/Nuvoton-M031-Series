...
void UART_DisableInt(UART_T  *uart, uint32_t u32InterruptFlag)
{
    ...
    if(uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))
        NVIC_DisableIRQ(UART02_IRQn);
    else if(uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))
...
void UART_Open(UART_T *uart, uint32_t u32baudrate)
{
    ...
    uint32_t u32ClkTbl[6ul] = {(32000000UL), 0ul, (32768UL), (48000000UL), 0ul, (38400UL)};
    uint32_t u32Baud_Div = 0ul;


    if (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))
    {
         
        u32UartClkSrcSel = ((uint32_t)(((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x7ul << (24)))) >> (24);
         
        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV0 & (0xful << (8))) >> (8);
    }
    else if (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x7ul << (28))) >> (28);
         
        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV0 & (0xful << (12))) >> (12);
    }
    else if (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x72000)))
    {
         
        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (24))) >> (24);
         
        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (0))) >> (0);
    }
    ...
    if (u32UartClkSrcSel == 4ul)
    {
        ...
        if ((uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x70000))) || (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x72000))))
        {
...
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t u32ClkTbl[6ul] = {(32000000UL), 0ul, (32768UL), (48000000UL), 0, (38400UL)};
    uint32_t u32Baud_Div = 0ul;
    ...
    if (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))
    {
        ...
        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x7ul << (24))) >> (24);
...
void UART_SelectIrDAMode(UART_T *uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x72000)))
    {
...
uint32_t UART_Write(UART_T *uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    ...
    for (u32Count = 0ul; u32Count != u32WriteBytes; u32Count++)
    {
        ...
        while ((uart->FIFOSTS & (0x1ul << (28))) == 0ul)    
        {
            u32delayno++;
