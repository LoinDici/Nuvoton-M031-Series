...
#line 323 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
...
{
    while(((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (23)));

    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT = ch;
    if(ch == '\n')
    {
        while(((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (23)));
        ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT = '\r';
    }
}

#line 504 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
...
{
#line 545 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    SendChar_ToUART(ch);
...
{
#line 583 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    while(1)
    {
        if((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (14))) == 0)
        {
            return (((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT);
        }
    }
...
int kbhit(void)
{
    ...
    return !((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (14))) == 0);
...
int IsDebugFifoEmpty(void)
{
    ...
    return ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (28))) != 0);
...
#line 706 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
