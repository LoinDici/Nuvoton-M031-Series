                  ...
                  uint32_t u32BusClock)
{
    ...
    if(spi != ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000))) return (0x00ul);
    ...
    if(u32MasterSlave == (0x0ul))
    {
        ...
        if(u32BusClock >= u32HCLKFreq)
        {
            ...
            if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))
                ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (~(0x3ul << (4)))) | (0x2UL<<(4));
        }

         
        if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))
        {
            if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x0UL<<(4)))
                u32ClkSrc = (32000000UL);  
            else if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x1UL<<(4)))
                u32ClkSrc = CLK_GetPLLClockFreq();  
            else if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x2UL<<(4)))
                u32ClkSrc = u32HCLKFreq / ((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV & (0x7ul << (0)))+1);
            else
                u32ClkSrc = 48000000;  
        }
    ...
    else      
    {
        ...
        return (CLK_GetHCLKFreq() / ((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV & (0x7ul << (0)))+1));
    }
}
...
void SPI_Close(SPI_T *spi)
{
    if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))
    {
        ...
        ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST1 |= (0x1ul << (13));
        ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST1 &= ~(0x1ul << (13));
    }
}
...
uint32_t SPI_SetBusClock(SPI_T *spi, uint32_t u32BusClock)
{
    ...
    if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))
    {
        if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x0UL<<(4)))
            ...
            u32ClkSrc = CLK_GetHCLKFreq() / ((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV & (0x7ul << (0)))+1);
        else
            u32ClkSrc = 48000000;  
    }
...
uint32_t SPI_GetIntFlag(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x001ul)) && (spi->STATUS & (0x1ul << (1))))
        u32IntFlag |= (0x001ul);

     
    if((u32Mask & (0x002ul)) && (spi->STATUS & (0x1ul << (2))))
        u32IntFlag |= (0x002ul);

     
    if((u32Mask & (0x004ul)) && (spi->STATUS & (0x1ul << (3))))
        u32IntFlag |= (0x004ul);

     
    if((u32Mask & (0x008ul)) && (spi->STATUS & (0x1ul << (7))))
        u32IntFlag |= (0x008ul);

     
    if((u32Mask & (0x010ul)) && (spi->STATUS & (0x1ul << (6))))
        u32IntFlag |= (0x010ul);

     
    if((u32Mask & (0x040ul)) && (spi->STATUS & (0x1ul << (19))))
        u32IntFlag |= (0x040ul);

     
    if((u32Mask & (0x080ul)) && (spi->STATUS & (0x1ul << (18))))
        u32IntFlag |= (0x080ul);

     
    if((u32Mask & (0x100ul)) && (spi->STATUS & (0x1ul << (10))))
        u32IntFlag |= (0x100ul);

     
    if((u32Mask & (0x200ul)) && (spi->STATUS & (0x1ul << (11))))
        u32IntFlag |= (0x200ul);

     
    if((u32Mask & (0x400ul)) && (spi->STATUS & (0x1ul << (12))))
        u32IntFlag |= (0x400ul);
...
uint32_t SPI_GetStatus(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x01ul)) && (spi->STATUS & (0x1ul << (0))))
        u32Flag |= (0x01ul);

     
    if((u32Mask & (0x02ul)) && (spi->STATUS & (0x1ul << (8))))
        u32Flag |= (0x02ul);

     
    if((u32Mask & (0x04ul)) && (spi->STATUS & (0x1ul << (9))))
        u32Flag |= (0x04ul);

     
    if((u32Mask & (0x08ul)) && (spi->STATUS & (0x1ul << (16))))
        u32Flag |= (0x08ul);

     
    if((u32Mask & (0x10ul)) && (spi->STATUS & (0x1ul << (17))))
        u32Flag |= (0x10ul);

     
    if((u32Mask & (0x20ul)) && (spi->STATUS & (0x1ul << (23))))
        u32Flag |= (0x20ul);

     
    if((u32Mask & (0x40ul)) && (spi->STATUS & (0x1ul << (15))))
        u32Flag |= (0x40ul);

     
    if((u32Mask & (0x80ul)) && (spi->STATUS & (0x1ul << (4))))
        u32Flag |= (0x80ul);
...
static uint32_t SPII2S_GetSourceClockFreq(SPI_T *i2s)
{
    ...
    if(i2s != ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000))) return (0x00ul);

    if(i2s == ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))
    {
        if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x0UL<<(4)))
            u32Freq = (32000000UL);  
        else if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x1UL<<(4)))
        ...
        else if((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x3ul << (4))) == (0x2UL<<(4)))
        {
            ...
            u32Freq = u32HCLKFreq / ((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV & (0x7ul << (0)))+1);
        }
        else
            u32Freq = 48000000;  
    }
...
uint32_t SPII2S_Open(SPI_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat)
{
    ...
    if(u32MasterSlave == (0x0ul))
    {
        ...
        u32BitRate = u32SampleRate * ((u32WordWidth >> (4)) + 1) * 16;
        ...
        u32SampleRate = u32BitRate / (((u32WordWidth >> (4)) + 1) * 16);
    ...
    else
    {
        ...
        return (u32HCLKFreq / ((((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV & (0x7ul << (0)))+1));
    }
}
