...
#line 13 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M031\\Source\\system_M031Series.c"
...
#line 14 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M031\\Source\\system_M031Series.c"
...
#line 15 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M031\\Source\\system_M031Series.c"
...
const uint32_t gau32ClkSrcTbl[] = {(32000000UL), (32768UL), (96000000UL), (38400UL), (48000000UL), 0UL, 0UL, (48000000UL)};
...
void SystemCoreClockUpdate(void)
{
    ...
    u32ClkSrc = ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL0 & (0x7ul << (0));
    ...
    u32HclkDiv = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV0 & (0xful << (0))) + 1;
...
void SystemInit(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL = ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL & ~(0x7ul << (20));
    if (((32000000UL) >= 4000000) && ((32000000UL) < 8000000))
    {
        ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL |= (1 << (20));
    }
    else if (((32000000UL) >= 8000000) && ((32000000UL) < 12000000))
    {
        ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL |= (2 << (20));
    }
    else if (((32000000UL) >= 12000000) && ((32000000UL) < 16000000))
    {
        ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL |= (3 << (20));
    }
    else if (((32000000UL) >= 16000000) && ((32000000UL) < 24000000))
    {
        ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL |= (4 << (20));
    }
    else
    {
        ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PWRCTL |= (7 << (20));
    }
