...
volatile uint8_t g_u8SlvTxData[256];
volatile uint8_t g_au8SlvRxData[7];

volatile uint8_t g_u8DeviceAddr;
volatile uint8_t g_u8SlvDataLen;
volatile static I2C_FUNC s_I2C0HandlerFn = 0;
...
void I2C0_IRQHandler(void)
{
    ...
    u32Status = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->STATUS0);


	
    if(( ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ))
    {
         
        I2C_ClearTimeoutFlag(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)));
    }
    else
    {
...
void I2C_SlaveTRx(uint32_t u32Status)
{
	...
	switch (u32Status) {
      ...
      ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->CTL0 = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->CTL0 & ~0x3C) | (0x0CUL));
		break;
		case 0x80:	 
			u8data = (unsigned char) ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->DAT);
		...
		case 0xA8:	 
			  SpiFlash_WaitReady();
				...
				((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->DAT = (slave_buff_addr));
				((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->DAT = (g_u8SlvTxData[slave_buff_addr]));
        slave_buff_addr++;
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->CTL0 = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)))->CTL0 & ~0x3C) | (0x0CUL));
		break;
		case 0xB8:	 
...
void I2C0_Init(void)
{
    ...
    I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)), 400000);

     
    printf("I2C clock %d Hz\n", I2C_GetBusClockFreq(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))));

     
    I2C_SetSlaveAddr(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)), 0, 0x15, 0);    
#line 170 "..\\i2c_transfer.c"
     
    I2C_EnableInt(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)));
...
void I2C0_Close(void)
{
    ...
    I2C_DisableInt(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)));
    NVIC_DisableIRQ(I2C0_IRQn);

     
    I2C_Close(((I2C_T *) ((( uint32_t)0x40000000) + 0x80000)));
    CLK_DisableModuleClock(((((1) & 0x03UL) << 30)|((((8)) & 0x1fUL) << 0) | (((0x0) & 0x03UL) << 28)|(((0x0) & 0x07UL) << 25)|(((0x0) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)));
